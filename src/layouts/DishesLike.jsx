...
//       const favorite = cartLikeTmp.find(item => item.id === id)

//       setIsFavorite(!isFavorite)   
//     }

//     return (
//         <div className={isFavorite ? 'dishes__item_like-active' : 'dishes__item_like'} onClick={() => {addFavourite(); addCartFavourite()}}>
...
// //       // : setCartLike([...cartLike, item.id])

// //       const favorite = cartLikeTmp.find(item => item.id === id)
      
// //       console.log(cartLikeTmp) //проверка проходит

// //       // setCartLike([...cartLike, favorite]);
// //       setIsFavorite(!isFavorite)   
// //   }
// // //  useEffect (() => {
// // //     addCartFavourite()
