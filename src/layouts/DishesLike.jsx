...
function DishesLike(id) {
    const {addCartFavourite} = useContext(AppContext)
    const {isFavourites, setIsFavourites} = useContext(AppContext)
    ...
    return (
        <div className={!isFavourites ? 'dishes__item_like' : 'dishes__item_like-active'} onClick={() => {addCartFavourite(id); addFavourite(id)}}>
